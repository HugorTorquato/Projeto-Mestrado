...
EXEC spCreateProcessedPVPowerDataDiffTable    -- Process 1F power data (Populate table spProcessedPVPowerDataDiff)
EXEC spSUMCreateProcessedPVPowerDataDiffTable -- Process 3F power data (Populate table spSUMProcessedPVPowerDataDiff)
