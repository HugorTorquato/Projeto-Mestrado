---------------------------------------------------------
-- This view returns all the cases that a VW control
...
CREATE OR ALTER VIEW vwGetVWControlActivation
AS
	-- Caso para identificar o VW atuando só
	WITH 
	voltavar AS (
		SELECT 
				*--DISTINCT(id_Summary)
			...
			WHERE 
				( Measurement like 'volt-var' AND [Value] = 9999)
