CREATE OR ALTER   VIEW [dbo].[vwHCCResultsTable2]
AS
	WITH
		...
		BATSUM AS (
			SELECT
				...
				, [AVG_SUM_Eergy_Diff_5_4]
				, [AVG_SUM_Eergy_Diff_7_6]
		...
		ByCase as (
			SELECT 
				...
				, BATSUM.[AVG_SUM_Eergy_Diff_5_4]
				, BATSUM.[AVG_SUM_Eergy_Diff_7_6]
				...
				, ( BATSUM.[AVG_SUM_Eergy_Diff_5_4] / ( GroupHC.Sum_Energy_Case_4 - GroupHC.Sum_Energy_Case_2 ) ) AS HCC4
				, ( BATSUM.[AVG_SUM_Eergy_Diff_7_6] / ( GroupHC.Sum_Energy_Case_6 - GroupHC.Sum_Energy_Case_2 ) ) AS HCC6
			FROM BATSUM
...
select * from [vwHCCResultsTable2]
select AVG(HCC4) , AVG(HCC6) from [vwHCCResultsTable2]